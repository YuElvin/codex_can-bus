...
- F-76 开发基线 HEAD：`22840382e542d99f6b8e59e3ad0cbfce768f8197`。
- 分支：`codex/W5500`，跟踪 `origin/codex/W5500`。
- F-76 源码、治理与对话记录待本轮统一提交推送；不得拆出或覆盖用户无关修改。
...
先只读形成阶段 G 最终验收矩阵：逐项标注“可复用证据/需烟雾回归/必须补验”，固定同一最终候选和最少人工操作窗口；不得由派送会话自行选择新功能或扩大范围。
