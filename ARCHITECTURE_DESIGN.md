...
| 11 | 规则/继电器 | 部分已验证 | 最小 `marker==42434` 规则已烧录验证：PE7 高、PE8 低，停帧超过 1500 ms 两路安全回低；完整配置、手动优先级、延时和滞回待做 |
