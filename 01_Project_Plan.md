...
| 12 | 稳定性基线 | [进行中；日志、断网、HTTP RST 与冷启动恢复已通过] | F-11/12 HWFC 固件已完成30分17秒插卡日志耐久；F-14 已验证 W5500 网线恢复；F-17 已修复成功响应后 `DISCON→CLOSE` 的主机RST；F-19 第二次真实冷启动已验证 DBC、v3两规则、外部CAN解码和默认日志恢复。F-16 仅验证错误被动恢复，未形成 bus-off；F-20 仍待错误 HTTP 400 后的现场时序定界。TF运行中插拔仍为非支持操作 |
