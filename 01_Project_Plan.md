...
| 12 | 稳定性基线 | [进行中；日志、断网、HTTP RST、400错误响应与冷启动恢复已通过] | F-11/12 HWFC 固件已完成30分17秒插卡日志耐久；F-14 已验证 W5500 网线恢复；F-17 已修复成功响应后 `DISCON→CLOSE` 的主机RST；F-19 第二次真实冷启动已验证 DBC、v3两规则、外部CAN解码和默认日志恢复；F-20 已验证非法规则 HTTP 400 后 `+0/+50/+100/+250/+500 ms` 新连接均为200。F-21 已用错误比特率形成真实bus-off，但恢复500k超过60秒仍未退出，F-24 正在定义最小恢复状态机。TF运行中插拔仍为非支持操作 |
